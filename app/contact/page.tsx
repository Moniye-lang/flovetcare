  ...
  return (
    <div className="bg-gray-50 text-[#333] min-h-screen p-6 md:p-12">
      ...
      <div className="flex flex-col lg:flex-row gap-10">
        ...
        {/* Google Map */}
        <div className="w-full lg:flex-1 h-64 sm:h-80 md:h-[500px] rounded-xl overflow-hidden shadow-lg">
          <iframe
        ...
        <div className="w-full lg:w-[45%] flex flex-col gap-8">
          ...
          <div className="text-center">
            <h2 className="text-3xl sm:text-4xl md:text-[40px] text-teal-900 font-bold mb-4">
              Business Hours
            </h2>

            <div className="grid grid-cols-2 justify-center gap-x-8 sm:gap-x-12 gap-y-2">
          ...
          <div className="flex flex-col sm:flex-row sm:justify-center gap-8 text-center">
            ...
            {/* Phone */}
            <div>
              <h3 className="text-2xl sm:text-3xl md:text-[30px] font-bold mb-1">
                Phone
              </h3>
              <a
                href="tel:07939416298"
                className="underline text-base sm:text-lg md:text-[22px]"
              >
                07939416298
              </a>
            </div>
            ...
            <div>
              ...
              <a
                href="mailto:flovetcare@gmail.com?subject=Hello&body=I want to contact you"
                className="underline text-base sm:text-lg md:text-[22px]"
              >
